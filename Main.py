...
class Main:
    ...
    def maketypes(bill, types):
        ...
        goodPDateRegex = '"productionDate":"([\d-]+)"'
        goodEDateRegex = '"expirationDate":"([\d-]+)"'
        ...
        for typeContent in typesContent:
            ...
            for goodContent in goodsContent:
                ...
                goodPDate = re.search(goodPDateRegex,goodContent).group(1)
                goodEDate = re.search(goodEDateRegex,goodContent).group(1)
